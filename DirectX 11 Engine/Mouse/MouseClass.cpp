...
MouseEvent MouseClass::ReadEvent()
{
	...
	{
		MouseEvent e = this->eventBuffer.front(); //-- 이벤트 버퍼 앞에 있는 내용을 가져온다.
		this->eventBuffer.pop(); //--가져온 내용을 버퍼에서 삭제
		return e;
	}
}
